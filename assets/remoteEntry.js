...
"./Remote":()=>{
      ...
      return __federation_import('/remote-app/assets/__federation_expose_Remote-B6_8sqmh.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
